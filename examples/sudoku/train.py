...
saveModelPath = f'data/model_data{numOfData}.pt'

print(f'Use {numOfData} data to train the NN for 4000 epochs by NN only method (i.e., CrossEntropy loss)')
...
for i in range(41):
    ...
    print(f'Train Acc Using Pure NN (whole board): {acc:0.2f}%')
    print(f'Train Acc Using Pure NN (single cell): {singleAcc:0.2f}%')
