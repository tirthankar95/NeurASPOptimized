    ...
    for epoch in range(epochs):
        ...
        for i_batch,batch in enumerate(train_loader):
            ...
            if (epoch+1)%100==0:
                ...
                print(f'Training set (single batch): Loss = {loss}    grid_cell_acc = {acc} whole_board_acc={true_acc}')
        ...
        if (epoch+1)%100==0:
            ...
            print(f'validation set             : Loss = {loss}     grid_cell_acc = {acc} whole_board_acc, is {whole_acc_weighted/whole_val_denom}')
